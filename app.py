...
<svg viewBox="0 0 850 750" xmlns="http://www.w3.org/2000/svg" style="background:white; border:1px solid #333;">
    ...
    <text x="425" y="32" text-anchor="middle" font-size="20" font-weight="bold">{title_text}</text>
    ...
    <line x1="425" y1="50" x2="425" y2="280" stroke="#ccc" stroke-dasharray="5,5" />
    ...
    <text x="600" y="365" font-size="13" font-weight="bold" fill="blue">{e_road}</text>
    <text x="100" y="365" font-size="13" font-weight="bold" fill="blue">{w_road}</text>

    <g font-size="11" font-weight="bold">
        <rect x="360" y="60" width="60" height="25" fill="white" stroke="black"/><text x="390" y="77" text-anchor="middle">Out:{out_n}</text>
        <rect x="430" y="60" width="60" height="25" fill="white" stroke="black"/><text x="460" y="77" text-anchor="middle">In:{in_n}</text>
    ...
    <g transform="translate(300, 290)">
        <rect x="0" y="0" width="40" height="15" fill="white" stroke="black"/><text x="20" y="12" text-anchor="middle" font-size="14">↱</text>
        <rect x="0" y="15" width="40" height="15" fill="white" stroke="black"/><text x="20" y="27" text-anchor="middle" font-size="9">{v['wr']}</text>
        <rect x="0" y="30" width="40" height="15" fill="white" stroke="black"/><text x="20" y="42" text-anchor="middle" font-size="14">→</text>
        <rect x="0" y="45" width="40" height="15" fill="white" stroke="black"/><text x="20" y="57" text-anchor="middle" font-size="9">{v['wt']}</text>
        <rect x="0" y="60" width="40" height="15" fill="white" stroke="black"/><text x="20" y="72" text-anchor="middle" font-size="14">↳</text>
        <rect x="0" y="75" width="40" height="15" fill="white" stroke="black"/><text x="20" y="87" text-anchor="middle" font-size="9">{v['wl']}</text>
    </g>

    <g transform="translate(510, 380)">
        <rect x="0" y="0" width="40" height="15" fill="white" stroke="black"/><text x="20" y="12" text-anchor="middle" font-size="14">↰</text>
        <rect x="0" y="15" width="40" height="15" fill="white" stroke="black"/><text x="20" y="27" text-anchor="middle" font-size="9">{v['er']}</text>
        <rect x="0" y="30" width="40" height="15" fill="white" stroke="black"/><text x="20" y="42" text-anchor="middle" font-size="14">←</text>
        <rect x="0" y="45" width="40" height="15" fill="white" stroke="black"/><text x="20" y="57" text-anchor="middle" font-size="9">{v['et']}</text>
        <rect x="0" y="60" width="40" height="15" fill="white" stroke="black"/><text x="20" y="72" text-anchor="middle" font-size="14">↲</text>
        <rect x="0" y="75" width="40" height="15" fill="white" stroke="black"/><text x="20" y="87" text-anchor="middle" font-size="9">{v['el']}</text>
    </g>

    <rect x="580" y="580" width="200" height="90" fill="#fafafa" stroke="#333" rx="5"/>
    ...
    <text x="595" y="665" font-size="11" font-style="italic" fill="#666">Calculated by Fratar Method</text>
</svg>
</div>
"""

st.components.v1.html(svg_content, height=750)
